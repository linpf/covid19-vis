...
def provs_hrs_cumulative_cases_bar_chart(province,health_region):
...
#                groups_list["cumulative_deaths"] = int(row_data["cumulative_deaths"]) 
    ...
    with open("../data/Covid19Canada/timeseries_hr/cases_timeseries_hr.csv", 'r') as file:
        ...
        for row in csv_file:
            ...
            data_x_y[(row_data["province"],"health_region")] = int(row_data["cumulative_cases"])
...
if __name__ == "__main__":
    ...
    provs_hrs_cumulative_cases_lines_chart()
