...
def bc_cases_daily_age_chart():
    ...
    chart.title = "BC daily reported Cases by age"
    chart.x_labels = sorted_report_days 
    chart.x_labels_major = [day for day in sorted_report_days if day[:2] == "01" ]
    chart.render_to_file('bc_daily_cases_by_age_stacked_chart.svg')
    ...
    chart.x_labels = ["age"]
    chart.render_to_file('bc_cases_by_age_stacked_chart.svg')

if __name__ == "__main__":
    bc_cases_daily_age_chart()
