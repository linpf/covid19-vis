...
urlpatterns = [
   ...
   path("bc_cases_and_testing/", views.bc_cases_and_testing_view, name="bc_cases_and_testing"),
   path("bc_cases_and_testing/<str:start_date>/<str:end_date>/", views.bc_cases_and_testing_view, name="bc_cases_and_testing"),
